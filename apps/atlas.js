...
function composeAtlasRules(shortcutRules = []) {
  return [
    ...
    {
      reg: "^(?!#(?:今日|今天|每日|我的|明天|明日|周(?:[1-7]|一|二|三|四|五|六|日))*(?:素材|材料|天赋)[ |0-9]*$)[#*%％][\\s\\S]{1,}(?:命座|星魂|影画|天赋)$",
      fnc: "shortcutQuery",
    },
    {
      reg: "^(?!#(?:今日|今天|每日|我的|明天|明日|周(?:[1-7]|一|二|三|四|五|六|日))*(?:素材|材料|天赋)[ |0-9]*$)#(?:星铁|星穹铁道|崩坏星穹铁道|崩铁|绝区零|绝区|原神)?[\\s\\S]{1,}(?:命座|星魂|影画|天赋)$",
      fnc: "shortcutQuery",
    },
    {
    ...
    {
      reg: "^(?![#*%％]?[\\s\\S]*(?:攻略|练度统计)[\\s\\S]*$)(?!(?:#(?:星铁)?|\\*)(?:队伍伤害|队伤|伤害|单人评级)[\\s\\S]*$)(?![#*%％]?(?:星铁|星穹铁道|崩坏星穹铁道|崩铁|绝区零|绝区|原神)?(?:日历|日历列表)\\d{0,3}$)(?!#(?:今日|今天|每日|我的|明天|明日|周(?:[1-7]|一|二|三|四|五|六|日))*(?:素材|材料|天赋)[ |0-9]*$)(?![#*%％]?(?:星铁|绝区零|原神)?(?:锅巴登录|体力|树脂|便笺|便签|多体力|全部体力|更新面板|面板更新|更新抽卡记录|刷新抽卡记录|全部记录|角色记录|武器记录|常驻记录|新手记录|抽卡记录|刷新cookie|扫码登录|米哈游登录|账号密码登录|密码登录|登录帮助|签到|注册自动签到|远程|spawn|上传|下载|B站|BBDown|帮助|菜单|命令|版本|状态|深渊|深境螺旋|幻想|幻想真境剧诗|剧诗|幽境|危战|幽境危战|混沌|混沌回忆|忘却|忘却之庭|末日|末日幻影|虚构|虚构叙事|异相|异相仲裁|防卫|防卫战|式舆|式舆防卫|式舆防卫战|危局|危局强袭战|强袭|强袭战)\\d{0,3}$)(?![#*%％]?(?:星铁|星穹铁道|崩坏星穹铁道|崩铁|绝区零|绝区|原神)?(?:最强|极限)[\\s\\S]*$)(?![#*%％]?[\\s\\S]*(?:面板|面版)(?:[1-9]|[1-9]\\d|1\\d\\d|2[0-4]\\d|25[0-5])?$)(?![#*%％]?[\\s\\S]*(?:练度统计|天赋统计|技能统计|角色查询|查询角色|角色列表|面板角色|角色面板|深渊|深境|深境螺旋|幻想|幻境|剧诗|幻想真境剧诗|幽境|危战|幽境危战|混沌|混沌回忆|忘却|忘却之庭|虚构|虚构叙事|末日|末日幻影|异相|异相仲裁|防卫|防卫战|式舆|危局|强袭|临界|推演|爬塔|月报|菲林|邦布券|收入|探索|探索度|个人信息|卡片|card)\\s*(?:[1-9]|[1-9]\\d|1\\d\\d|2[0-4]\\d|25[0-5])$)(?![#*%％]?[\\s\\S]*(?:面板|面版)\\s*[\\s\\S]*[换变改][\\s\\S]*$)(?![#*%％]?[\\s\\S]*(?:排名|排行|排行榜)$)(?:#[\\s\\S]{2,}|\\*[\\s\\S]{2,}|[%％][\\s\\S]{2,})$",
      fnc: "shortcutQuery",
      log: false,
    },
    {
