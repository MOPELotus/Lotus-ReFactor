...
function composeAtlasRules(shortcutRules = []) {
  return [
    ...
    {
      reg: "^(?![#*%％]?(?:星铁|绝区零|原神)?(?:锅巴登录|体力|树脂|便笺|便签|多体力|全部体力|更新面板|面板更新|更新抽卡记录|刷新抽卡记录|刷新cookie|扫码登录|米哈游登录|账号密码登录|密码登录|登录帮助|签到|注册自动签到|远程|spawn|上传|下载|B站|BBDown|帮助|菜单|命令|版本|状态|深渊|深境螺旋|幻想|幻想真境剧诗|剧诗|混沌|混沌回忆|忘却|忘却之庭|末日|末日幻影|虚构|虚构叙事|异相|异相仲裁|防卫|防卫战|式舆|式舆防卫|式舆防卫战|危局|危局强袭战|强袭|强袭战)\\d{0,3}$)(?![#*%％]?[\\s\\S]*面板$)(?:#[\\s\\S]{2,}|\\*[\\s\\S]{2,}|[%％][\\s\\S]{2,})$",
      fnc: "shortcutQuery",
      log: false,
    },
    {
